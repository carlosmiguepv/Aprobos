...
{
    public partial class BD_APROBADOSContext : DbContext
    {
        public BD_APROBADOSContext()
        {
        }

        public BD_APROBADOSContext(DbContextOptions<BD_APROBADOSContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LAPTOP-9Q6APE6P;Database=BD_APROBADOS;User=sa;Pwd=123456789");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Administrador>(entity =>
            {
                entity.HasKey(e => e.IdAdministrador)
                    .HasName("PK__ADMINIST__134EB62AEABDD754");
            ...
            modelBuilder.Entity<Adoptar>(entity =>
            {
                entity.HasKey(e => e.IdAdoptar)
                    .HasName("PK__ADOPTAR__1FD728CA6433DBB7");
                ...
                entity.HasOne(d => d.IdAdministradorNavigation)
                    ...
                    .HasConstraintName("FK__ADOPTAR__ID_ADMI__47DBAE45");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Adoptar)
                    .HasForeignKey(d => d.IdUsuario)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ADOPTAR__ID_USUA__48CFD27E");
            });

            modelBuilder.Entity<Codigo>(entity =>
            {
                entity.HasKey(e => e.IdCodigo)
                    .HasName("PK__CODIGO__B4138395D64E4C03");
                ...
                entity.HasOne(d => d.IdSponsorNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CODIGO__ID_SPONS__44FF419A");
            });

            modelBuilder.Entity<Comentario>(entity =>
            {
                entity.HasKey(e => e.IdComentario)
                    .HasName("PK__COMENTAR__4B0815B111B2C906");
                ...
                entity.Property(e => e.EstadoComentario)
                    .IsRequired()
                    .HasMaxLength(20)
                    .IsUnicode(false)
                ...
                entity.HasOne(d => d.IdUsuarioNavigation)
                    ...
                    .HasForeignKey(d => d.IdUsuario)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__COMENTARI__ID_US__4BAC3F29");
            });

            modelBuilder.Entity<Mascota>(entity =>
            {
                entity.HasKey(e => e.IdMascota)
                    .HasName("PK__MASCOTA__FC5D150DC8B75BC7");
                ...
                entity.HasOne(d => d.IdTipoNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__MASCOTA__ID_TIPO__38996AB5");

                entity.HasOne(d => d.IdUsuarioNavigation)
                    .WithMany(p => p.Mascota)
                    .HasForeignKey(d => d.IdUsuario)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__MASCOTA__ID_USUA__398D8EEE");
            });

            modelBuilder.Entity<Pais>(entity =>
            {
                entity.HasKey(e => e.IdPais)
                    .HasName("PK__PAIS__B68D33A17099B0FB");
            ...
            modelBuilder.Entity<Publicacion>(entity =>
            {
                entity.HasKey(e => e.IdPublicacion)
                    .HasName("PK__PUBLICAC__C7ABD961389331C2");
                ...
                entity.HasOne(d => d.IdAdministradorNavigation)
                    ...
                    .HasForeignKey(d => d.IdAdministrador)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PUBLICACI__ID_AD__3E52440B");

                entity.HasOne(d => d.IdMascotaNavigation)
                    .WithMany(p => p.Publicacion)
                    .HasForeignKey(d => d.IdMascota)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PUBLICACI__ID_MA__403A8C7D");
            ...
            modelBuilder.Entity<Raza>(entity =>
            {
                entity.HasKey(e => e.IdRaza)
                    .HasName("PK__RAZA__C3517CEE7A6321EE");
            ...
            modelBuilder.Entity<Sponsor>(entity =>
            {
                entity.HasKey(e => e.IdSponsor)
                    .HasName("PK__SPONSOR__6680929A4DBE0BC2");
            ...
            modelBuilder.Entity<Tipo>(entity =>
            {
                entity.HasKey(e => e.IdTipo)
                    .HasName("PK__TIPO__DB4DE8AB7BE76D30");
                ...
                entity.HasOne(d => d.IdRazaNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TIPO__ID_RAZA__267ABA7A");
            });

            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__USUARIO__91136B9024CE268D");
                ...
                entity.HasOne(d => d.IdPaisNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__USUARIO__ID_PAIS__35BCFE0A");
            });
